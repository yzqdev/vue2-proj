<template>
  <div class="page-shopping-cart" id="shopping-cart">
    ...
    <div class="cart-product-title clearfix">
      ...
      <div class="td-price fl"><span>单价(元)</span></div>
      <div class="td-total fl"><span>金额(元)</span></div>
      ...
      <table>
        <tbody>
          ...
          <tr v-for="(item, index) in productList" :key="index">
            ...
            <td class="td-product">
              <img :src="item.pro_img" width="98" height="98" alt="图片" />
              <div class="product-info">
                <h6>{{ item.pro_name }}</h6>
                <p>
                  品牌：{{ item.pro_brand }}&nbsp;&nbsp;产地：{{
                    item.pro_place
                  }}
                </p>
                <p>
                  规格/纯度:{{ item.pro_purity }}&nbsp;&nbsp;起定量：{{
                    item.pro_min
                  }}
                </p>
            ...
            <td class="td-num">
              <div class="product-num">
                <a
                  ...
                  @click="item.pro_num > 0 ? item.pro_num-- : ''"
                  ><span></span
                ></a>
      ...
      productList: [
        {
          ...
          pro_num: 3, //数量
          pro_img: require("../../assets/庄周.jpg"), //图片链接
          pro_price: 800, //单价
        },
        {
          pro_name: "【斯文】甘油 | 丙三醇", //产品名称
...
.product-delect:hover {
  background-color: #af1326;
  box-shadow: 5px 5px 0 #ff8296;
}
</style>
