<template>
  <div class="form-group">
    <div class="input-group">
      ...
      <i
        class="material-icons i-clear"
        v-show="isEmptySearchKey"
        v-on:click.stop="clearAction"
        >clear</i
      >
      <i class="material-icons i-search" v-on:click.stop="searchAction"
        >search</i
      >
    </div>
  </div>
...
import { isEmptySearchKey } from "@/store/getters";
export default {
  vuex: {
    getters: {
