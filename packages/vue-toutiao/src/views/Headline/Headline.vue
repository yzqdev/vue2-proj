      ...
      <div class="header-box">
        ...
        >
          <div class="item-t df-sb">
            ...
            <div
              class="item-t-r"
              @click.stop="item.attention = !item.attention"
            >
          ...
          <div class="item-b df-c">
            ...
            <div
              class="item-b-icon df-c"
              :class="{ 'item-b-icon-active': item.islike }"
...
<script>
import TopBar from "./HeadlineTopBar.vue";
  ...
  methods: {
    loadingMore() {
      return new Promise(async (resolve, reject) => {
        this.pageindex++;
        await this.$store.dispatch("getHeadlineList", {
